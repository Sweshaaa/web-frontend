      ...
      <AuthLayout>
        <div className={styles.formWrapper}>
          ...
          <form className={styles.form} onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className={styles.fieldGroup}>
              ...
              <div className={styles.inputWrapper}>
                <span className={styles.inputIcon}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.35 2 2 0 0 1 3.59 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.56a16 16 0 0 0 5.53 5.53l.97-.97a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
                  </svg>
                </span>
                <input
                  type="tel"
                    ...
                    <div className={styles.strengthBars}>
                      {[1,2,3,4].map(i => (
                        <div
                          ...
                          style={{ background: i <= passwordStrength ? strengthColors[passwordStrength] : 'var(--gray-200)' }}
                        />
                      ))}
                    </div>
              ...
              <div className={styles.fieldGroup}>
                ...
                <div className={styles.inputWrapper}>
                  ...
                  <input
                    ...
                    className={`${styles.input} ${errors.confirmPassword ? styles.inputError : ''} ${confirmValue && passwordValue === confirmValue ? styles.inputSuccess : ''}`}
          ...
          <div className={styles.socialButtons}>
            ...
            <button className={styles.socialBtnApple}>
